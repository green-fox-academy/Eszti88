...
#### Your answer: You can generate a random number between 0 and 1 with a built-in function called Math.random().If you would like to get a higher value, simply multiply the random value with another number.
